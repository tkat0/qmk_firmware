...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * | Shift|   Z  |   X  |   C  |   V  |   B  |Alfred|                    | DASH |   N  |   M  |   ,  |   .  |   /  |   =  |
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    ALFRED,                         _______, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_EQL, \
    PS1,     PS2,     KC_LALT, KC_LGUI, KC_LGUI,  LENT,    LANG,                          KC_BSPC, RSPC , KC_RSFT,   KC_F7,   KC_F8,   KC_F9,   KC_F10   \
  ),
  ...
  [_LOWER] = LAYOUT( \
    ...
    _______, _______, _______, _______, _______, _______, KC_LPRN,                        KC_RPRN, _______, _______, _______, KC_F11,  KC_F12,  _______, \
    _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   _______,                        _______, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______, \
    _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    _______,                        _______, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______, \
    _______, _______, _______, _______, _______, LENT ,   _______,                        _______, RSPC , _______,   _______, _______, _______, _______  \
  ),
  ...
  [_RAISE] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______, _______,                        _______, KC_BSPC, KC_UP,   KC_SPC,  _______, _______, _______, \
    _______, _______, _______, _______, _______, _______, _______,                        _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_ENT,  _______, _______, \
    _______, _______, _______, _______, _______, LENT ,   _______,                        _______, RSPC , _______,   _______, _______, _______, _______  \
  ),
